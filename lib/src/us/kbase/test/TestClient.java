...
public class TestClient {
     ...
     * credentials.
     */
    public TestClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    public FilterContigsResults filterContigs(FilterContigsParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<FilterContigsResults> res = caller.jsonrpcCall("test.filter_contigs", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("test.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
