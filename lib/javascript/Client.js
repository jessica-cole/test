...
function test(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.filter_contigs = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "test.filter_contigs",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "test.status",
